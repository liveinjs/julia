...
// Memory map:
//  The complete address space is divided up
//  into a multi-level page map.
//  These constants define the branching factor.
//  These constants plus GC_PAGE_LG2 therefore must sum to sizeof(void*).
//  They should be multiples of 32 (sizeof(uint32_t)), except REGION2_PG_COUNT can be 1.
#ifdef _P64
